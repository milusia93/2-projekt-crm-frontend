...
const AddClient = () => {
    ...
    const validateForm = (e) => {
        ...
        return (validationErrors.name || validationErrors.address.street || validationErrors.address.zipCode || validationErrors.address.city || validationErrors.nip)
    }
    // console.log(errors)
    ...
    return (
        <div>
            <div className="formContainer">
                <AddClientForm handleInputChange={handleInputChange} handleAddressChange={handleAddressChange} handleSubmit={handleSubmit} addedClient={addedClient} errors={errors} />
            </div>
            <div>
